...
#ifdef CHIP_A12
#define CHIP_PLL_PER			(1150)
#define CHIP_VID_PER			(18)
#define CHIP_PLL_FAC			(1000)
#define CHIP_VID_FAC			(20)
#define CHIP_PLL_BAL			(1100)
#define CHIP_VID_BAL			(20)
#define CHIP_PLL_EFF			(900)
#define CHIP_VID_EFF			(28)
