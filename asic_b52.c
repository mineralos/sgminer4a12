...
const uint8_t default_reg[PLL_LV_NUM][REG_LENGTH] = 
{
...
static const uint8_t difficult_Tbl[6][32] = {
	 /**128*/
...
//    memcpy(jobdata + 2 + BLOCK_HEADER_LEN, work->target, TARGET_LEN);
    ...
    {
        //jobdata[(BLOCK_HEADER_LEN + 2) + i] = work->target[TARGET_LEN - i - 1];
        jobdata[(BLOCK_HEADER_LEN + 2) + i] = target[TARGET_LEN - i - 1];
    }
...
//    memset(tmp_buf, 0, sizeof(tmp_buf));
    ...
    applog(LOG_NOTICE, "**********target: %s", htarget);
    free(htarget);
